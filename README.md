...
I benchmarked several model variants and attention mechanisms on medical datasets (NIH & COVID), analyzing performance trade-offs across accuracy, efficiency, and interpretability.
...
├── model_vit_small.py              # ViT-Small/Tiny architecture
